...
but you can rename it, if you want. This implements a system where you will be answering your question and turn the learn card on click.
After confirming how well you answered, you can rate your answer below for correctness on a scale of 1-10 (10 is the highest score, therefore perfect answer).
The game will keep track of your progress when you click quit and repeat questions you can improve on. To reset the learning process you can delete the progress.txt
There is a function in the program that lets you update your set of questions, but you will need to understand python a bit for this or ask a LLM for help ;)
Have fun learning!
